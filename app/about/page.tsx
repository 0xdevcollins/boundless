...
const VALUES: ValueItem[] = [
  {
    icon: Star,
    title: "Stellar First",
    description: "We're fully dedicated to supporting projects building on the Stellar ecosystem, focusing all our resources on this network."
  },
  {
    icon: Heart,
    title: "Community Driven",
    description: "Our platform puts power in the hands of the community, where backers vote on projects and give valuable feedback to creators."
  },
  {
    icon: CheckCircle,
    title: "Milestone Based",
    description: "We release funding as projects reach verified milestones, ensuring accountability and giving backers confidence in their investments."
  },
  {
    icon: Code,
    title: "Technical Excellence",
    description: "We prioritize projects with strong technical foundations and provide expert mentorship throughout the development process."
  },
  {
    icon: Globe,
    title: "Global Access",
    description: "Using Stellar's fast, low-cost transactions, we make funding accessible to creators from all around the world."
  },
  {
    icon: LineChart,
    title: "Sustainable Growth",
    description: "We focus on long-term project success rather than quick wins, supporting founders who are building for lasting impact."
  }
];
...
const HISTORY: HistoryItem[] = [
  {
    year: "Mid 2024",
    title: "The Idea",
    description: "Boundless was born as a solution to fix funding challenges for Stellar ecosystem projects. We developed our core concept and formed our initial team.",
    icon: Sparkles
  },
  {
    year: "Late 2024",
    title: "Stellar Community Fund",
    description: "We presented our vision at the Stellar Community Fund meeting, securing $10,000 in XLM funding to turn our concept into reality.",
    icon: Gift
  },
  {
    year: "Early 2025",
    title: "Platform Development",
    description: "We built the Boundless platform with a focus on security, transparency, and easy user experience for both creators and backers.",
    icon: Code
  },
  {
    year: "2025",
    title: "Launch & Partnerships",
    description: "We officially launched Boundless and formed partnerships with open-source projects like OnlyDust to grow our ecosystem and create more opportunities.",
    icon: Handshake
  }
];
    ...
    <PageTransition>
      <div className="min-h-screen bg-background">
        ...
        <section className="relative pt-28 pb-20 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-primary/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-primary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }}></div>
          <div className="absolute top-1/4 left-1/4 w-1/3 h-1/3 bg-primary/8 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
          ...
          <div className="container max-w-6xl mx-auto px-4 relative z-10">
            <div className="flex flex-col items-center text-center">
              ...
              >
                Helping innovators in the Stellar ecosystem get community-backed funding and technical support.
              </motion.p>
            </div>
          </div>
        </section>
              ...
              <div className="w-full md:w-1/2">
                ...
                >
                  <p className="text-lg mb-6">
                    Boundless connects innovative builders with passionate backers who believe in the future of the Stellar ecosystem. 
                  </p>
                  <p className="text-muted-foreground mb-8">
                    Our platform breaks down the barriers to funding by creating a clear, milestone-based system where great ideas get the resources they need, and backers can follow the journey from start to finish.
                  </p>
                ...
                >
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-card rounded-lg p-6 shadow-md flex flex-col items-center text-center hover:shadow-lg transition-all duration-300 hover:translate-y-[-2px]">
                      ...
                      <p className="text-2xl font-bold text-primary mb-1">150+</p>
                    ...
                    <div className="bg-card rounded-lg p-6 shadow-md flex flex-col items-center text-center hover:shadow-lg transition-all duration-300 hover:translate-y-[-2px]">
                      ...
                      <p className="text-sm text-muted-foreground">XLM Raised</p>
                    </div>
                  </div>
                </motion.div>
              </div>
        ...
        <section className="py-20 bg-background relative overflow-hidden" ref={teamRef}>
          ...
          <div className="container max-w-6xl mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mt-4">
                Meet the people behind Boundless who are dedicated to helping creators on Stellar
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/30" ref={historyRef}>
          <div className="container max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <div className="relative inline-block">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">The Boundless Story</h2>
            ...
            <div className="relative">
              {/* Center line */}
              <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-primary/40 via-primary/20 to-primary/5 rounded-full"></div>
            ...
            <div className="rounded-2xl border border-primary/20 bg-card/70 shadow-lg p-8 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">Built Only for Stellar</h3>
                    <p className="text-muted-foreground">We're fully focused on supporting new ideas in the Stellar ecosystem</p>
                  </div>
                </div>
        ...
        <section className="py-20 bg-background">
          <div className="container max-w-6xl mx-auto px-4">
            <div className="bg-gradient-to-r from-primary/5 via-card to-primary/5 rounded-2xl border border-primary/20 p-8 md:p-12 shadow-xl relative overflow-hidden hover:shadow-2xl transition-all duration-300">
              {/* Background elements */}
              <div className="absolute -top-20 -right-20 w-64 h-64 bg-primary/10 rounded-full blur-3xl opacity-70 animate-pulse" style={{ animationDuration: "8s" }}></div>
              <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-primary/10 rounded-full blur-3xl opacity-70 animate-pulse" style={{ animationDuration: "12s" }}></div>
              
              <div className="relative flex flex-col md:flex-row gap-10 items-center justify-between">
                <div className="w-full md:w-2/3">
                  <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 text-primary mb-6 border border-primary/20">
                    <Rocket className="h-4 w-4 mr-2" />
                    <span className="text-sm font-medium">Ready to Join Us?</span>
                  </div>
                  
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">Be Part of Something Bigger</h2>
                  <p className="text-xl text-muted-foreground mb-8">
                    Whether you're a creator with a bold idea or a backer looking to support innovation, Boundless is where great ideas take flight.
                  </p>
                  
                  <div className="flex flex-wrap gap-6">
                    <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/20 px-8 py-6 text-lg hover:translate-y-[-2px] transition-all duration-300">
                      <Rocket className="mr-2 h-5 w-5" /> Start Your Project
                    </Button>
                    <Button size="lg" variant="outline" className="border-primary/20 hover:border-primary/50 px-8 py-6 text-lg hover:translate-y-[-2px] transition-all duration-300">
                ...
                <div className="w-full md:w-1/3 flex justify-center md:justify-end">
                  ...
                  <div className="relative w-56 h-56 flex items-center justify-center">
                    <div className="absolute inset-0 rounded-full bg-primary/10 animate-pulse" style={{ animationDuration: "4s" }}></div>
                    <div className="absolute inset-4 rounded-full bg-primary/5 border border-primary/20 flex items-center justify-center">
                      <div className="w-20 h-20 relative">
                        ...
                        <div className="absolute inset-0 animate-spin" style={{ animationDuration: "10s" }}>
                          <div className="h-4 w-4 bg-primary rounded-full absolute -top-2 left-1/2 transform -translate-x-1/2"></div>
                          <div className="h-4 w-4 bg-primary/60 rounded-full absolute top-1/2 -right-2 transform -translate-y-1/2"></div>
                          <div className="h-4 w-4 bg-primary/40 rounded-full absolute -bottom-2 left-1/2 transform -translate-x-1/2"></div>
                          <div className="h-4 w-4 bg-primary/20 rounded-full absolute top-1/2 -left-2 transform -translate-y-1/2"></div>
                        </div>
                      </div>
                    </div>
                    <div className="absolute top-0 left-0 w-full h-full animate-spin" style={{ animationDuration: "15s" }}>
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-3 h-3 bg-primary/30 rounded-full"></div>
                      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-3 h-3 bg-primary/30 rounded-full"></div>
                      <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-3 h-3 bg-primary/30 rounded-full"></div>
                      <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-3 h-3 bg-primary/30 rounded-full"></div>
                    </div>
                  </div>
                </div>
              </div>
