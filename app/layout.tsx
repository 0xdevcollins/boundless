...
export const metadata: Metadata = {
	...
	description:
		"Boundless is a decentralized crowdfunding platform built on the Stellar blockchain. Create, support, and manage projects with transparent funding through Soroban smart contracts.",
	keywords: [
		"boundless",
		"stellar",
		"crowdfunding",
