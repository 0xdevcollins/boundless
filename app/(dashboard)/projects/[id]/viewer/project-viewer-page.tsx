        ...
        <div className=" absolute left-0 top-0 z-10">
          <div className="container py-3 px-4">
            <div className="flex items-center text-sm text-muted-foreground">
              <Link href="/projects" className="text-white hover:text-foreground font-bold transition-colors">
                Projects
              </Link>
              <span className="mx-2">/</span>
              <span className="font-semibold text-white/80">{project.title}</span>
            </div>
          </div>
        </div>
        <Image
              ...
              <div className="flex flex-col md:flex-row md:items-end gap-6">
                ...
                <div className="flex-1 text-white">
                  <div className="flex flex-wrap gap-2 mb-2">
                    <Badge variant="secondary" className="bg-white hover:bg-white/30">
                      {project.category}
                    </Badge>
                    <Badge
                      variant={
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  {/* PUBLISH BUTTON: Only show if owner, validated, not published */}
                ...
                <div className="mt-6">
                  {project.pitchDeck ? (
                    <Button
                      variant="outline"
                      className="mr-4"
                      onClick={() => window.open(project.pitchDeck || '', '_blank')}
                    >
                      <FileText className="mr-2 h-4 w-4" /> View Pitch Deck
                    </Button>
                  ) : (
                    <Button variant="outline" className="mr-4" disabled>
                      <FileText className="mr-2 h-4 w-4" /> Pitch Deck Unavailable
                    </Button>
                  )}

                  {project.whitepaper ? (
                    <Button variant="outline" onClick={() => window.open(project.whitepaper || '', '_blank')}>
                      <FileText className="mr-2 h-4 w-4" /> View Whitepaper
                    </Button>
                  ) : (
                    <Button variant="outline" disabled>
                      <FileText className="mr-2 h-4 w-4" /> Whitepaper Unavailable
                    </Button>
                  )}
                </div>
              </CardContent>
      ...
      <Dialog open={showPublishModal} onOpenChange={setShowPublishModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to publish this campaign? Once published, you will start accepting funds and the
              campaign deadline will begin.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
        ...
        <div className="container px-4 mt-4">
          <Card className="bg-primary/10 border-primary">
            <CardContent className="py-4 flex items-center justify-between">
              <span className="font-semibold text-primary">Campaign is LIVE</span>
