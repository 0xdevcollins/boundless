...
export function ViewerMilestones({ projectId }: ViewerMilestonesProps) {
  ...
  return (
    <Card className="h-[320px] overflow-y-scroll">
      <CardHeader>
        <CardTitle>Project Milestones</CardTitle>
        <CardDescription>Track the progress of this project through its key milestones</CardDescription>
      </CardHeader>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  {milestone.status === 'COMPLETED' ? (
                    ...
                    <div className="flex items-center text-muted-foreground">
                      ...
                      <span>{milestone.status === 'IN_PROGRESS' ? 'In progress' : 'Not started'}</span>
                    </div>
                  )}
                </div>
              </div>
