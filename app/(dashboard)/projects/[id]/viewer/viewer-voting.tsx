...
export function ViewerVoting({ projectId, voteCount, userVoted, status, compact = false }: ViewerVotingProps) {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button onClick={handleVote} disabled={hasVoted || status !== 'PENDING' || isVoting} size="sm">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleVote} disabled={hasVoted || status !== 'PENDING' || isVoting} className="gap-2">
