    ...
    <Card>
      <CardContent className="p-6 space-y-6">
        <div className="flex flex-col space-y-6">
          ...
          {session ? (
            <CommentInput projectId={projectId} onCommentAdded={refreshComments} />
          ) : (
          ...
          {isLoading ? (
            ...
            <CommentsList comments={comments} onCommentUpdated={refreshComments} currentUserId={session?.user?.id} />
          )}
