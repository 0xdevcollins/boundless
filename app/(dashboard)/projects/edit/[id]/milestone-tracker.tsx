...
export function MilestoneTracker({ isTeamMember, projectId }: MilestoneTrackerProps) {
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle>Project Milestones</CardTitle>
          {isTeamMember && <MilestoneForm projectId={projectId} onSuccess={fetchMilestones} />}
        </div>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          {milestones.length === 0 ? (
            <div className="text-center text-muted-foreground">
              No milestones yet. {isTeamMember && 'Add your first milestone to get started!'}
            </div>
          ) : (
