	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Control how and when you receive notifications from Boundless.
				</CardDescription>
			</CardHeader>
					...
					<div className="space-y-4">
						...
						<div className="flex items-center justify-between">
							<div className="space-y-0.5">
								...
								<p className="text-sm text-gray-500">
									Receive emails when someone comments on your projects
								</p>
							</div>
							<Switch
						...
						<div className="flex items-center justify-between">
							<div className="space-y-0.5">
								...
								<p className="text-sm text-gray-500">
									Receive emails about funding milestones for your projects
								</p>
							</div>
							<Switch
					...
					<div className="space-y-4">
						...
						<div className="flex items-center justify-between">
							<div className="space-y-0.5">
								...
								<p className="text-sm text-gray-500">
									Receive push notifications about funding milestones for your
									projects
								</p>
							</div>
							<Switch
						...
						<div className="flex items-center justify-between">
							<div className="space-y-0.5">
								...
								<p className="text-sm text-gray-500">
									Receive push notifications about platform announcements and
									updates
								</p>
							</div>
							<Switch
