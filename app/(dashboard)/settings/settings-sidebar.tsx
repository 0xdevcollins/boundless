...
import { BellIcon, ShieldIcon, UserIcon } from '@/components/settings/components/icons';
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <div className={`text-sm ${isActive ? 'text-white/80' : 'text-gray-500'}`}>{tab.description}</div>
              </div>
            </button>
          );
        })}
