...
import { Code, Globe, Handshake, Lightbulb, Shield, ShieldCheck, Zap } from 'lucide-react';
          ...
          <div className="container max-w-6xl mx-auto px-4 md:px-6 relative">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  Boundless is revolutionizing how innovative projects get funded. We combine the power of
                  community-driven funding with the security and efficiency of the Stellar blockchain.
                </motion.p>
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-muted-foreground">Secure, transparent funding through blockchain technology</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="mt-1 bg-primary/10 p-2 rounded-full">
                      <Globe className="h-5 w-5 text-primary" />
                    </div>
                    <p className="text-muted-foreground">Global accessibility with low fees and fast transactions</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="mt-1 bg-primary/10 p-2 rounded-full">
                      <Handshake className="h-5 w-5 text-primary" />
                    </div>
                    <p className="text-muted-foreground">Community-driven decision making and project validation</p>
                  </div>
                </motion.div>
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <h3 className="text-2xl font-semibold mb-4">Innovation Through Community</h3>
                      <p className="text-muted-foreground">
                        Join a network of creators and backers shaping the future of decentralized funding
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              <p className="text-sm text-muted-foreground mb-6">Built on and powered by</p>
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  At Boundless, we&apos;re building the future of crowdfunding by leveraging blockchain technology to
                  create a more transparent, efficient, and accessible platform for creators and backers alike.
                </p>
                <p className="text-lg text-muted-foreground">
                  Our platform combines the power of community-driven funding with the security and efficiency of the
                  Stellar blockchain, enabling innovative projects to thrive while giving backers unprecedented
                ...
                <div className="space-y-4">
                  <div className="bg-card p-6 rounded-lg border border-border">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Process contributions in seconds with Stellar&apos;s high-speed network
                    </p>
                  </div>
                  <div className="bg-card p-6 rounded-lg border border-border">
                    <Code className="h-8 w-8 text-primary mb-4" />
                    <h3 className="font-semibold mb-2">Smart Contracts</h3>
                    <p className="text-sm text-muted-foreground">Secure, automated fund management through Soroban</p>
                  </div>
                </div>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container max-w-6xl mx-auto px-4 md:px-6">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold tracking-tighter mb-6">Our Values</h2>
              <p className="text-lg text-muted-foreground">These core principles guide everything we do at Boundless</p>
            </motion.div>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container max-w-6xl mx-auto px-4 md:px-6">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold tracking-tighter mb-6">Join Our Journey</h2>
              <p className="text-lg text-muted-foreground mb-8">
                Be part of the future of crowdfunding. Whether you&apos;re a creator with a vision or a backer looking
                to support innovative projects, Boundless is your platform.
              </p>
