...
export default function Page() {
	...
	// App cards data with modern gradients - unique colors
	const appCards = [
		{
			...
			color: "from-indigo-600/90 to-indigo-500/70",
		...
		},
		{
			...
			color: "from-emerald-600/90 to-emerald-500/70",
			textColor: "text-white",
		},
		{
			...
			color: "from-violet-600/90 to-violet-500/70",
			textColor: "text-white",
		},
		{
			...
			color: "from-cyan-600/90 to-cyan-500/70",
			textColor: "text-white",
		},
		{
			title: "Tokenization",
			...
			color: "from-rose-600/90 to-rose-500/70",
			textColor: "text-white",
		},
		{
			...
			color: "from-amber-600/90 to-amber-500/70",
			textColor: "text-white",
		},
	];
	...
	const benefits = [
		{
			...
			icon: Zap,
			details:
				"Process 1000s of transactions per second with consistent performance",
		},
		{
		...
		},
		{
			...
			icon: ShieldCheck,
			details:
				"Immutable ledger with multi-signature support and transparent operations",
		},
		{
			...
			icon: Globe,
			details:
				"Built-in currency exchange and borderless transaction capabilities",
		},
		{
			title: "Eco-Friendly",
		...
		},
		{
			...
			icon: Coins,
			details:
				"Create branded tokens for rewards, ownership, or creative use cases",
		},
	];
	...
	return (
		...
		>
					...
					<div className="flex flex-col lg:flex-row items-center gap-8 md:gap-16">
						...
						>
							...
							<p className="text-xl text-muted-foreground">
								Leverage Stellar&apos;s blockchain with Soroban smart contracts
								to create borderless financial solutions.
							</p>
							...
							<div className="pt-4 flex flex-wrap gap-4">
								...
								<Button
									size="lg"
									variant="outline"
									className="border-primary/20 hover:border-primary backdrop-blur-sm"
								>
									Explore Projects
								</Button>
							</div>
							...
							<div className="relative h-[400px] w-full">
								...
								{floatingElements.map((item) => (
									...
									>
										<div
											className={
												"w-16 h-16 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 backdrop-blur-lg flex items-center justify-center border border-primary/20 shadow-lg"
											}
										>
								...
								<svg
									...
									role="img"
									aria-label="Dynamic connection lines between floating elements"
								>
									{floatingElements.map((item) => (
										<motion.line
											key={`line-${item.id}`}
			...
			{/* Modern Apps Section */}
			<section
				className="py-12 md:py-24 bg-gradient-to-b from-background via-primary/5 to-background relative overflow-hidden"
				ref={appsRef}
			>
				<div className="container max-w-6xl mx-auto px-4 relative z-10">
					<div className="mb-8 md:mb-16 text-center">
						...
						>
							...
							<p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
								Build on Stellar&apos;s platform with Rust-based Soroban smart
								contracts for enterprise-grade solutions
							</p>
						</motion.div>
					</div>
					...
					<div className="flex flex-col-reverse lg:flex-row gap-8 md:gap-12 items-center">
						...
						<div className="w-full lg:w-3/5">
							<div className="h-[400px] md:h-[520px] relative">
								<AnimatePresence mode="wait">
									{appCards.map((card, index) => (
										<motion.div
											key={card.title}
											className={`absolute w-full h-full ${index === activeCard ? "z-20" : "z-10"}`}
										...
										>
											<div
												className={`h-full w-full rounded-xl md:rounded-2xl bg-gradient-to-br ${card.color} backdrop-blur-lg border border-white/10 p-4 md:p-8 shadow-xl overflow-hidden relative transition-all duration-300`}
											>
												<div className="absolute inset-0 bg-black/10 backdrop-blur-sm" />

												<div className="flex flex-col h-full relative z-10">
													<div className="mb-4 md:mb-6">
														<div className="w-12 h-12 md:w-16 md:h-16 rounded-lg md:rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center mb-4 md:mb-6">
													...
													<div className="mt-auto">
														<div className="mb-4 border-t border-white/10 pt-4 md:pt-6">
															<h4 className="text-base md:text-lg font-medium text-white mb-2 md:mb-3">
																Use Cases:
															</h4>
															<div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
																{card.examples.map((example) => (
																	<div
																		key={`${card.title}-${example}`}
																		className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 md:px-4 md:py-3 text-white flex items-center hover:bg-white/20 transition-all"
																	>
																		<div className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-white mr-2 md:mr-3" />
														...
														<div className="flex justify-between items-center">
															<Button className="bg-white/10 text-white hover:bg-white/20 backdrop-blur-lg border border-white/10 text-sm md:text-base">
								...
								<div className="flex items-start gap-4 mb-4">
									...
									<div>
										...
										<p className="text-muted-foreground">
											Develop secure financial logic using Rust-based smart
											contracts on Stellar&apos;s Soroban platform.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-muted-foreground mb-4">
											Stellar meets financial industry standards with ISO 27001
				...
				<div className="container max-w-6xl mx-auto px-4">
					...
					>
						...
						<p className="text-lg text-muted-foreground">
							Enterprise-grade blockchain infrastructure for financial
							innovation
						</p>
					</motion.div>
						...
						<div className="relative flex flex-col md:flex-row gap-12 items-center justify-between">
							<div className="w-full md:w-2/3">
								...
								<p className="text-xl text-muted-foreground mb-8">
									Access funding, tools, and support to bring your financial
									innovation to life on Stellar.
								</p>
