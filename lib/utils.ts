import type { ActiveProject, PastProject, SortOption, TabOption, UserComment } from '@/types/contributions';
...
export function formatValidationStatus(status: ValidationStatus | null | undefined) {
...
export function filterActiveProjects(
  ...
  return projects.filter((project) => {
    ...
    if (activeTab === 'votes' && project.userComments > 0 && !project.userVoted && !project.userRejected) {
      return false;
    }
...
export function filterComments(comments: UserComment[], searchQuery: string): UserComment[] {
...
export function sortActiveProjects(projects: ActiveProject[], sortOption: SortOption): ActiveProject[] {
...
export function sortPastProjects(projects: PastProject[], sortOption: SortOption): PastProject[] {
  return [...projects].sort((a, b) => {
    if (sortOption === 'newest') {
...
export function sortComments(comments: UserComment[], sortOption: SortOption): UserComment[] {
