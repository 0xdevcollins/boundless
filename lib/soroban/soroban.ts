...
const CONTRACT_ADDRESS = 'CCCVHFXEQ5RBRRW4YX35TZ5X4D5ZZVLORIQXJB6ECI2BY5HBYBLD34PZ';
 ...
 */
export const stringToSymbol = (value: string) => nativeToScVal(value, { type: 'symbol' });
 ...
 */
export const numberToScVal = (value: number) => nativeToScVal(value, { type: 'u64' });

/**
 * Interacts with the Soroban smart contract.
 */
export const contractInteraction = async (functName: string, values?: xdr.ScVal[]) => {
