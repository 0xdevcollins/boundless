...
export function ProjectDetails({ project, totalFunding, fundingPercentage }: ProjectDetailsProps) {
  return (
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{format(new Date(project.createdAt), "PPP")}</p>
              </div>
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  >
                    {project.ideaValidation.charAt(0) + project.ideaValidation.slice(1).toLowerCase()}
                  </Badge>
                </div>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {project._count.votes} votes • {project._count.comments} comments
                </p>
              </div>
            </div>
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <Link href={`/admin/users/${project.user.id}`} className="text-xs text-blue-600 hover:underline">
                  View Profile
                </Link>
              </div>
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">${project.fundingGoal.toLocaleString()} goal</span>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {project.fundings.filter((f: any) => f.status === "COMPLETED").length}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm">Pending Fundings</span>
                <span className="font-medium">
                  {project.fundings.filter((f: any) => f.status === "PENDING").length}
                </span>
              </div>
            </div>
          </CardContent>
