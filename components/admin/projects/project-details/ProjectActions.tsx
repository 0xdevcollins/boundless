	...
	const handleApproveProject = async () => {
		...
		try {
			const response = await fetch(
				`/api/admin/projects/${project.id}/approve`,
				{
					method: "PATCH",
					headers: {
			...
			toast.error("Error", {
				description:
					error instanceof Error
						? error.message
						: "Failed to approve project. Please try again.",
			});
		} finally {
			setIsLoading(false);
		}
		...
		try {
			...
			toast.error("Error", {
				description:
					error instanceof Error
						? error.message
						: "Failed to reject project. Please try again.",
			});
		} finally {
			setIsLoading(false);
		}
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							project and all associated data including team members,
							milestones, and fundings.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
