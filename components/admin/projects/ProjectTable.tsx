...
import { Check, ChevronLeft, ChevronRight, Eye, MoreHorizontal } from "lucide-react"
...
type ProjectCategory = "TECHNOLOGY" | "ART" | "SCIENCE" | "EDUCATION" | "COMMUNITY" | "OTHER"
...
interface TableProject {
  ...
  createdAt: Date
  updatedAt?: Date // Made optional to fix the type error
  isApproved: boolean
...
export function ProjectsTable({ projects, currentPage, totalPages }: ProjectsTableProps) {
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground mt-1">
                            {project._count.fundings} fundings · {project._count.votes} votes
                          </div>
                        </div>
                      </div>
                    </TableCell>
