...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div ref={imageRef} className="flex items-start space-x-3 sm:space-x-4 mb-3 sm:mb-4">
        {/* Image on the left */}
        ...
        <div ref={contentRef} className="flex-1 min-w-0">
          <h3 className="text-white text-lg sm:text-xl font-bold mb-2 line-clamp-1">{project.name}</h3>
      ...
      <div ref={bottomRef} className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
