      ...
      <div className='px-5'>
        <div className='space-y-3'>
          <h3 className='text-xl font-medium text-white md:text-2xl'>
            Prototype & Smart Contract Setup
          </h3>
          <Badge
            variant='outline'
          ...
          <div className='flex items-center justify-start gap-2 text-xs md:text-sm'>
            ...
            <span className='text-gray-500'>05 Dec, 2025 - 31 Jan, 2026</span>
            <span className='text-[#E26E6A]'>Ended</span>
          </div>
          <div className='flex items-center justify-start gap-2 text-xs md:text-sm'>
            <span>
              <svg
            ...
            <span className='font-semibold text-white'>$12,300</span>
            <span className='text-[#fff]'>- (10% of total project fund)</span>
          </div>
        </div>
      </div>
