...
export default function BoundlessCTA() {
  ...
  return (
    <PageTransition>
      <section className="py-16 md:py-24 bg-gradient-to-b from-background to-background/90" ref={ref}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              >
                ...
                <div className="relative mb-6">
                  <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-8">Ready to Launch Your Vision?</h2>
                  <AnimatedUnderline isInView={isInView} />
                </div>

                <p className="text-lg text-muted-foreground mb-8">
                  Join Boundless today and connect with a community of backers eager to support innovative projects
                  built on Stellar technology.
                </p>
