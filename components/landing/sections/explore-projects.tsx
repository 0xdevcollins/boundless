...
import { ArrowRight, Clock, Globe, Sparkles, Users, Zap } from "lucide-react";
...
const projects = [
	{
		...
		category: "Finance",
		description:
			"A seamless payment solution built on Stellar for global transactions.",
		funding: 85,
		backers: 237,
		daysLeft: 12,
		icon: Globe,
	},
	{
		...
		category: "Storage",
		description:
			"Encrypted, decentralized storage solution powered by Stellar.",
		funding: 62,
		backers: 189,
		daysLeft: 23,
		icon: Zap,
	},
	{
		...
		category: "AI & Finance",
		description:
			"Automated trading strategies using machine learning algorithms.",
		funding: 93,
		backers: 412,
		daysLeft: 5,
		icon: Sparkles,
	},
	{
		...
		description:
			"A comprehensive explorer for the Stellar blockchain ecosystem.",
		funding: 71,
		backers: 156,
		daysLeft: 19,
		icon: Users,
				...
				<div className="container max-w-6xl mx-auto px-4 md:px-6">
					...
					>
						...
						<p className="text-lg text-muted-foreground mt-6">
							Discover innovative projects from our community of creators
									...
									<CardHeader className="pb-2 relative">
										<div className="flex justify-between items-start">
											...
											<div className="flex items-center text-sm text-muted-foreground">
												...
												<span
													className={
														project.daysLeft <= 5 ? "text-amber-500" : ""
													}
												>
										...
										<div className="mt-6">
											...
											<div className="flex justify-between mt-2 text-sm">
												<div className="flex items-center">
													...
													<span
														className={
															project.funding >= 80 ? "font-medium" : ""
														}
													>
