...
const Hero: React.FC<HeroProps> = ({ className }) => {
  ...
  const shapeVariants = {
    ...
    animate: { opacity: 0.5, scale: 1, transition: { duration: 1.5, ease: "easeOut" } },
    float: {
      y: [0, -15, 0],
      rotate: [0, 5, 0],
      transition: {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <motion.p 
            ...
            variants={subtitleVariants}
          >
            Pitch your blockchain idea to our community of backers for validation, funding, and smooth development—without the hassle.
          </motion.p>
