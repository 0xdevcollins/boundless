...
type CryptoCategoryType = 'DeFi Protocol' | 'NFT Marketplace' | 'Data DAOs' | 'AI Agents' | 'Web3 Storage';
...
const Hero: React.FC<HeroProps> = ({ className }) => {
  ...
  const categories = useMemo<CryptoCategoryType[]>(
    () => ['DeFi Protocol', 'NFT Marketplace', 'Data DAOs', 'AI Agents', 'Web3 Storage'],
    [],
  );
  ...
  useEffect(() => {
    ...
    const createParticles = () => {
      const particles = Array.from({ length: 50 }).map(() => {
        ...
        particle.classList.add('absolute', 'bg-primary', 'rounded-full', 'opacity-30');
  ...
  return (
    <div className={`relative w-full overflow-hidden bg-background py-20 lg:py-32 ${className}`}>
      {/* Particle background */}
      <div ref={particlesRef} className="absolute inset-0 pointer-events-none" style={{ zIndex: 0 }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            variants={subtitleVariants}
          >
            Pitch your blockchain idea to our community of backers for validation, funding, and smooth
