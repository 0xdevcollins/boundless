...
const steps: Step[] = [
	{
		...
		description:
			"Share your innovative project or creative vision with our global community.",
		icon: Lightbulb,
		details: {
			longDescription:
	...
	},
	{
		...
		description:
			"Receive valuable feedback from the community to refine your concept.",
		icon: Users,
		details: {
			longDescription:
	...
	},
	{
		...
		description:
			"Raise funds from backers interested in your project's success.",
		icon: Banknote,
		details: {
			longDescription:
								...
								{steps.map((step) => (
									...
									>
										<button
											...
											type="button"
											className={
												"flex·items-center·w-full·group·transition-all·duration-300"
											}
										>
											<div
												className={`
