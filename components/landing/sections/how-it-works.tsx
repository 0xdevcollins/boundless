        ...
        <div className="container max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <div className="relative inline-block">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-6">How Boundless Works</h2>
              <AnimatedUnderline isInView={isInView} />
            </div>
            <p className="text-lg text-muted-foreground mt-6">
              Reimagining what&apos;s possible through democratic funding, milestone-driven development, and
                      ...
                      >
                        <h4
                          className={`font-medium text-lg truncate ${
                            step.id === activeStep ? 'text-foreground' : 'text-muted-foreground'
                          }`}
                        >
                          {step.title}
                        </h4>
            ...
            <div className="w-full md:w-2/3 lg:w-3/4 order-1 md:order-2">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-muted-foreground text-lg mb-6">{currentStep?.details.longDescription}</p>
