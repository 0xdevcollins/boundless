...
import { Award, Coins, Rocket, Users } from "lucide-react";
			...
			<div className="container px-4 md:px-6">
				...
				>
					<h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
						Our Impact on the Stellar Ecosystem
					</h2>
					<p className="text-muted-foreground mt-2 md:text-lg">
						Empowering creators and backers through transparent blockchain
						funding
					</p>
				</motion.div>
								...
								<CardContent className="p-6">
									...
									<div className="space-y-1">
										...
										<div className="flex items-end">
											...
											<span className="text-2xl font-bold text-emerald-600 ml-1">
												{stat.suffix}
											</span>
										</div>
