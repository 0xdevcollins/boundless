    ...
    <div className="space-y-6">
      ...
      <div className="relative px-6">
        <div className="absolute -top-16">
          {image ? (
            <Image src={image} alt={name} width={128} height={128} className="rounded-full border-4 border-white" />
          ) : (
        ...
        <div className="mt-16">
          ...
          <div className="mt-6 grid grid-cols-3 gap-4">
            <div className="rounded-lg bg-gray-50 p-4">
              ...
              <p className="mt-1 text-2xl font-semibold">{totalContributions}</p>
            </div>
            <div className="rounded-lg bg-gray-50 p-4">
          ...
          <div className="mt-6 flex space-x-4">
            {twitter && (
              <a href={twitter} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900">
