		...
		<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-6">
			<Card>
				...
				<CardContent>
					...
					<span
						className={`text-xs ${analytics.contributions.isPositiveGrowth ? "text-green-500" : "text-red-500"}`}
					>
			...
			<Card>
				...
				<CardContent>
					<div
						className={`text-2xl font-bold ${analytics.roi.isPositive ? "text-green-500" : "text-red-500"}`}
					>
						{analytics.roi.value}
					</div>
					<p className="text-xs text-muted-foreground">
