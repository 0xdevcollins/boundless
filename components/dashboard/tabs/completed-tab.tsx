...
export default function CompletedTab({ projects, sort, setSort }: CompletedTabProps) {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant={sort === 'category' ? 'default' : 'outline'} size="sm" onClick={() => setSort('category')}>
            Category {sort === 'category' && <ArrowUpDown className="ml-2 h-3 w-3" />}
          </Button>
