...
import { DollarSign, FileImage, Upload, LinkIcon } from "lucide-react"
...
export function BasicInfoStep({ form, xlmPrice }: BasicInfoStepProps) {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter your project title" {...field} className="h-9" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
