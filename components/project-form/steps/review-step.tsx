...
import { FileText, Calendar, DollarSign, Users, Flag, FileUp, ChevronDown, ChevronUp } from "lucide-react"
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Review all the information before submitting</p>
