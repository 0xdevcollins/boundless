...
export function StepNavigation({ steps, currentStep, getStepCompletion, onNavigate }: StepNavigationProps) {
  return (
          ...
          return (
            ...
            >
              ...
              <div className="flex-1">
                <StepContent title={step.title} description={step.description} isActive={isActive} />
              </div>
            </div>
          )
        })}
